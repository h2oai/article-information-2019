...
\Author{Navdeep Gill $^{1, \dagger}$, Patrick Hall $^{1,\dagger,*}$, Kim Montgomery $^{1,\dagger}$, and Nicholas Schmidt $^{2, \dagger}$}
...
\indent \textsection \ref{ssec:soft} \textbf{Software resources}: GitHub repository for the results presented herein and utilized and useful Python packages.
