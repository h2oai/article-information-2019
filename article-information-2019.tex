...
\item \textbf{Post-hoc explanation}: %\href{https://github.com/SeldonIO/alibi}{\texttt{alibi}} \href{https://github.com/SauceCat/PDPbox}{\texttt{PDPbox}} gradients
\item \textbf{Discrimination testing}: in \href{https://github.com/dssg/aequitas}{\texttt{aequitas}} and \href{https://github.com/LASER-UMASS/Themis}{\texttt{Themis}}.
\item \textbf{Discrimination remediation}: Reweighing, adversarial de-biasing, learning fair representations, and reject option classification in \href{http://aif360.mybluemix.net/}{\texttt{AIF360}} \cite{kamiran2012data}, \cite{zhang2018mitigating}, \cite{lfr}, \cite{kamiran2012decision}.
\item \textbf{Model debugging}: %tensorflow stuff cleverhans, foolbox, SALib what-if
...
% e.g. the fairwashing or scaffolding of biased models with ML explanations or the privacy harms of ML explanations \cite{fair_washing}, \cite{scaffolding}, \cite{shokri2019privacy})
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\acknowledgments{Wen Phan for work in formalizing notation.}
