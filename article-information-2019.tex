...
%   - "metric" vs. "measure"
% CONTENT:
% - sim data: add error metrics, confirm statements about results
% - sim data xnn: update figure: connections, feed-forward direction, make subfigure reference match discrimination measure table
% - mort data: add error metrics, confirm statements about results
% - mort data: update figure: connections, feed-forward direction, make subfigure reference match discrimination measure table
% - make subfigure reference match XNN charts
