...
\item \textbf{Model documentation}: models cards \cite{model_cards}, e.g. \texttt{\url{https://github.com/openai/gpt-2/blob/master/model_card.md}}, \texttt{\url{https://modelcards.withgoogle.com/object-detection}}. 
