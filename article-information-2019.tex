...
The capability of $g^\text{XNN}$ to model nonlinear phenomenon and high-degree interactions is on display in Figure \ref{fig:mort_xnn_glob_ridge}. \ref{fig:mort_xnn_glob_ridge} \textbf{A} presents the sparse weights of the $g^\text{XNN}$ output layer, in which subnetworks 0,1,2,3,5,8, and 9 have large magnitude weights and subnetworks 4,6, and 7 have small to near-zero magnitude weights.
