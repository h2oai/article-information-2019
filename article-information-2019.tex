...
\caption{Mean Deep SHAP values across quintiles for the three most important input features for $g^\text{XNN}$ on the simulated test data. Deep SHAP values are reported in the probability space, after the application of the logit link function.}
\end{figure}  
