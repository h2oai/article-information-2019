...
\begin{itemize}[leftmargin=*,labelsep=5.8mm]
	...
	\item \textbf{Discrimination testing methods}: AIR, ME, and SMD -- \textsection\ref{ssec:di}
...
Metrics for testing discrimination in this text are:
...
\begin{table}[H]
\caption{Group size and accuracy for $g^\text{MGBM}$ and $g^\text{XNN}$ on the simulated test data.}
\centering
\begin{tabular}{cccc}
\toprule
\textbf{Class}	& $\mathbf{N}$	& \textbf{Model} 												& Accuracy \\
\midrule
Protected 1	& 3057.0		& \begin{tabular}{@{}c@{}} $g^\text{MGBM}$ \\ $g^\text{XNN}$\end{tabular}	& \begin{tabular}{@{}c@{}} 0.770 \\ 0.764\end{tabular} \\	
\midrule			 
Control 1		& 16943		& \begin{tabular}{@{}c@{}} $g^\text{MGBM}$ \\ $g^\text{XNN}$\end{tabular}	& \begin{tabular}{@{}c@{}} 0.739 \\ 0.751\end{tabular} \\	
\midrule
Protected 2	& 9916		& \begin{tabular}{@{}c@{}} $g^\text{MGBM}$ \\ $g^\text{XNN}$\end{tabular}	& \begin{tabular}{@{}c@{}} 0.758 \\ 0.761\end{tabular} \\	
\midrule
Control 2		& 10084		& \begin{tabular}{@{}c@{}} $g^\text{MGBM}$ \\ $g^\text{XNN}$\end{tabular}	& \begin{tabular}{@{}c@{}} 0.729 \\ 0.745\end{tabular} \\	
\bottomrule
\label{tab:sim_n_acc}
\end{tabular}
\end{table}
...
\begin{table}[H]
\caption{AIR, ME and SMD for $g^\text{MGBM}$ and $g^\text{XNN}$ on the simulated test data.}
\centering
\begin{tabular}{cccccc}
\toprule
\textbf{Model}		& \textbf{Protected Class}								& \textbf{Control Class}							& \textbf{AIR}							& \textbf{ME}								& \textbf{SMD} \\
\midrule
$g^\text{MGBM}$	& \begin{tabular}{@{}c@{}} Protected 1 \\ Protected 2\end{tabular}		& \begin{tabular}{@{}c@{}} Control 1 \\ Control 2\end{tabular}	& \begin{tabular}{@{}c@{}} \textcolor{red}{0} \\ \textcolor{red}{0}\end{tabular}	& \begin{tabular}{@{}c@{}} \textcolor{red}{0\%}\\ \textcolor{red}{0\%}\end{tabular}	& \begin{tabular}{@{}c@{}} \textcolor{red}{0} \\ \textcolor{red}{0}\end{tabular}\\
\midrule 
$g^\text{XNN}$		& \begin{tabular}{@{}c@{}} Protected 1 \\ Protected 2\end{tabular}		& \begin{tabular}{@{}c@{}} Control 1 \\ Control 2\end{tabular}	& \begin{tabular}{@{}c@{}} \textcolor{red}{0} \\ \textcolor{red}{0}\end{tabular}	& \begin{tabular}{@{}c@{}} \textcolor{red}{0\%}\\ \textcolor{red}{0\%}\end{tabular}	& \begin{tabular}{@{}c@{}} \textcolor{red}{0} \\ \textcolor{red}{0}\end{tabular} \\													
\bottomrule
\label{tab:sim_disc}
\end{tabular}
\end{table}
...
Figure \ref{fig:mort_mgbm_glob_pdp_ice} also displays PD and ICE for the unconstrained feature property value. Unlike DTI ratio and LTV ratio, PD for property value does not always follow the patterns established by ICE curves. While PD shows monotonically increasing prediction behavior on average, apparently influenced by large predictions at extreme $g^{\text{MGBM}}(\mathbf{X})$ percentiles, ICE curves for individuals at the 40\textsuperscript{th} percentile of $g^{\text{MGBM}}(\mathbf{X})$, and lower,  exhibit different prediction behavior with respect to property value. Some individuals at these lower percentiles display monotonically decreasing prediction behavior while others appear to show fluctuating prediction behavior. Property value is strongly right-skewed, with little data regarding high-value property from which $g^{\text{MGBM}}$ can learn. For the most part, reasonable predictions do appear to be carried from more densely populated regions to more sparsely populated regions. However, prediction fluctuations at lower $g^{\text{MGBM}}(\mathbf{X})$ percentiles are visible, and in a sparse region of property value. Such fluctuations can be caused by local data characteristics, modeled local interactions, or unfortunately, by overfitting or leakage of strong non-monotonic signal from important constrained features into the modeled behavior of non-constrained features. \textcolor{red}{This divergence of PD and ICE can be indicative of an interaction affecting property value under $g^{\text{MGBM}}(\mathbf{X})$ \cite{ice_plots}, and drivers of such interactions can often be elucidated using surrogate decision trees \cite{art_and_sci}.
}
...
\begin{table}[H]
\caption{Group size and accuracy for $g^\text{MGBM}$ and $g^\text{XNN}$ on the mortgage test data.}
\centering
\begin{tabular}{cccc}
\toprule
\textbf{Class}	& $\mathbf{N}$	& \textbf{Model} 												& Accuracy \\
\midrule
Black 		& 2608		& \begin{tabular}{@{}c@{}} $g^\text{MGBM}$ \\ $g^\text{XNN}$\end{tabular}	& \begin{tabular}{@{}c@{}} 0.654 \\ 0.702\end{tabular} \\	
\midrule			 
White 		& 28361		& \begin{tabular}{@{}c@{}} $g^\text{MGBM}$ \\ $g^\text{XNN}$\end{tabular}	& \begin{tabular}{@{}c@{}} 0.817 \\ 0.857\end{tabular} \\	
\midrule
Female 		& 8301		& \begin{tabular}{@{}c@{}} $g^\text{MGBM}$ \\ $g^\text{XNN}$\end{tabular}	& \begin{tabular}{@{}c@{}}  0.768 \\ 0.822\end{tabular} \\	
\midrule
Male 		& 13166		& \begin{tabular}{@{}c@{}} $g^\text{MGBM}$ \\ $g^\text{XNN}$\end{tabular}	& \begin{tabular}{@{}c@{}} 0.785 \\	0.847\end{tabular} \\	
\bottomrule
...
\begin{table}[H]
\caption{AIR, ME and SMD for $g^\text{MGBM}$ and $g^\text{XNN}$ on the mortgage test data.}
\centering
\begin{tabular}{cccccc}
\toprule
\textbf{Model}		& \textbf{Protected Class}								& \textbf{Control Class}							& \textbf{AIR}							& \textbf{ME}								& \textbf{SMD} \\
\midrule
$g^\text{MGBM}$	& \begin{tabular}{@{}c@{}} Black \\ Female\end{tabular}		& \begin{tabular}{@{}c@{}} White \\ Male\end{tabular}	& \begin{tabular}{@{}c@{}} 0.776 \\ 0.948\end{tabular}	& \begin{tabular}{@{}c@{}} 18.3\% \\ 4.1\%\end{tabular}	& \begin{tabular}{@{}c@{}} 0.628 \\ 0.084\end{tabular} \\
\midrule 
$g^\text{XNN}$		& \begin{tabular}{@{}c@{}} Black \\ Female\end{tabular}		& \begin{tabular}{@{}c@{}} White \\ Male\end{tabular}	& \begin{tabular}{@{}c@{}} 0.743 \\ 0.955\end{tabular}	& \begin{tabular}{@{}c@{}} 21.4\% \\ 3.6\%\end{tabular}	& \begin{tabular}{@{}c@{}} 0.621 \\ 0.105\end{tabular} \\													
